      ...
      >
        ...
        <div className="px-4 py-4 border-t border-gray-100 bg-white">
          ...
          {work.sourceUrl ? (
            ...
            <div className="flex items-center justify-center gap-2 w-full py-2.5 bg-gray-100 text-gray-400 text-sm font-medium rounded-xl cursor-not-allowed">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
              {work.sourceNote ? work.sourceNote[lang] : (lang === 'zh' ? '暂无源码' : 'No source available')}
            </div>
          )}
        </div>
      </div>
